...
async function main() {
  ...
  // approve crowdsale contract to spend 51% tokens
  await itManToken.approve(
    itManTokenCrowdsale.address,
    totalSupply.mul(ethers.BigNumber.from(51)).div(ethers.BigNumber.from(100))
  );
}
